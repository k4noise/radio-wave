...
define m = Character('Дети', color="#ff0000")

default is_stay_home = True
default is_write_today = True
default is_agree = True
...
label start:
    ...
    scene thinking_in_room with dissolve
    ...
    label go_outside:
        ...
        label cont1:
            scene artem_room with dissolve
            ...
            scene nikita_room_day with dissolve
            ...
            scene nikita_room_night with dissolve
            show nikita at left with dissolve:
                zoom 0.85
            show artem at center with dissolve
            show asya at right with dissolve:
        ...
        label retort:
            menu:
                asy "Можешь отрицать сколько угодно."
                "Возразить":
                    jump is_retort
                "Согласиться":
                    jump is_agree
        ...
        label is_agree:
            ...
            n "Конечно!"
            p "Конечно!"
            "Но вот Полина... Как же я был удивлен, когда она без раздумий согласилась..."
        ...
        label talk_with_asya_at_home:
            if not is_agree:
                ...
                n "Может поэтому Ася давно ничего не показывала нам?"
                a "Сейчас и узнаем."
            ...
            scene travel_in_city with dissolve
            show artem at left with dissolve:
                zoom 0.85
            show nikita at right with dissolve:
                zoom 0.75
            ...
            m "Я не нашёл ее в открытом доступе, но кажется уже все успели поиграть в это."
            m "Уже даже легенды складывают об этой игре на некоторых игровых форумах, но она и правда хороша, этот нуарный антураж и мрачный сюжет также придаёт ей таинственности и подпитывает легенды."
        ...
        label reason:
            ...
            p "На самом деле, если так подумать, то у нас есть практически все стадии разработки игры и соответствующие даты, поэтому и волноваться не о чем."
        ...
        label end_history:
            ...
            if is_write_today and is_no_matter and is_agree and is_stay_home:
                jump good_continue
            elif is_write_today and is_agree:
                jump good_continue
            elif is_stay_home and is_write_today and is_agree:
                jump good_continue
            elif is_write_today and is_agree and is_no_matter:
                jump good_continue
            else:
                jump bad_continue
