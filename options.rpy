...
define config.name = _("Radio waves")
...
define gui.about = _p("""
В разработке новеллы принимали участие:
Кузнецов Богдан - тимлид
Лошаков Данил - аналитик
Захаров Данил - сценарист
Павлинцева Александра - дизайнер
Кистанова Марина - разработчик
""")
...
define config.save_directory = "radiowave-1667402837"
